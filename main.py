...
# pyinstaller.exe --noconsole --onefile --add-data ".\src\Vorlagen\VorlageMonat.docx;." .\main.py
...
# - --add-data: Fügt zusätzliche Dateien (in diesem Fall die Word-Vorlage "VorlageMonat.docx") zur EXE hinzu
